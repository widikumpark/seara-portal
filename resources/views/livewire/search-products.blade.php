<div>
    <div class="mx-5">
        <div class="form-group px-20">
            <h1 class="title font-weight-bold mb-1">Search Products</h1>
                ...
                <div class="col-md-3  d-flex align-items-stretch" wire:click="viewProduct({{ $product['id'] }})">
                    <div class="card profile-card-4">
                        <div class="card-img-block">
                            ...
                            <img class="img-fluid" src="{{ $product['image_url_1'] }}" alt="{{ $product['name'] }}">
                        </div>
                        <div class="card-body pt-5">
                            <!-- <img src="soya.jpg" alt="profile-image" class="profile"/> -->
                            <h5 class="card-title ">{{ $product['name'] }}</h5>
                            <p class="card-text font-weight-bold">USD ${{ $product['price'] }} /
